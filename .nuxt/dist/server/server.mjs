...
const _routes = [
  {
    name: "araclar",
    path: "/araclar",
    component: () => import("./_nuxt/araclar-DYxoJZAl.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DuVGOmAB.js")
  },
  {
    name: "satislar",
    path: "/satislar",
    component: () => import("./_nuxt/satislar-572LtG5Y.js")
  },
  {
    name: "urunler",
    path: "/urunler",
    component: () => import("./_nuxt/urunler-CbxKEpHp.js")
  }
];
...
const layouts = {
  default: () => import("./_nuxt/default-D7VaM3Uo.js")
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DYVxU9-q.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-B80G5GEx.js"));
