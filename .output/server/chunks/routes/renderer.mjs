...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"description","content":"Warehouse management system for spare parts"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Warehouse Manager"};
