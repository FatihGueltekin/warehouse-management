  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(hasMoreCars)) {
        _push(`<button class="load-more-btn" data-v-a2ff69ec> Daha fazla arac g\xF6ster </button>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(hasLessCars)) {
        _push(`<button class="load-less-btn" data-v-a2ff69ec> Daha az arac g\xF6ster </button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div>`);
...
export { araclar as default };
//# sourceMappingURL=araclar-DYxoJZAl.mjs.map
