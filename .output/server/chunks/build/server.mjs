...
const _routes = [
  {
    name: "araclar",
    path: "/araclar",
    component: () => import('./araclar-DYxoJZAl.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-DuVGOmAB.mjs')
  },
  {
    name: "satislar",
    path: "/satislar",
    component: () => import('./satislar-572LtG5Y.mjs')
  },
  {
    name: "urunler",
    path: "/urunler",
    component: () => import('./urunler-CbxKEpHp.mjs')
  }
];
...
const layouts = {
  default: () => import('./default-D7VaM3Uo.mjs')
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DYVxU9-q.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-B80G5GEx.mjs'));
...
export { _export_sfc as _, __nuxt_component_1 as a, resolveRouteObject as b, navigateTo as c, useNuxtApp as d, entry$1 as default, useRuntimeConfig as e, injectHead as i, nuxtLinkDefaults as n, resolveUnrefHeadInput as r, useRouter as u };
